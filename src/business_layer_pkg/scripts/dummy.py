...
def req_streames_cb(req):
    streams_ids = {
        "streams": [
            {"name": "Front Camera", "type": "front", "connectionId": "dae8360a-829c-4e67-b32a-70d4e5b90353"},
            {"name": "Back Camera", "type": "back", "connectionId": "c2f1cde9-aabe-4f75-b764-bd54473d8c53"}        ]
    }

    return TriggerResponse(success=True,
        message=json.dumps(streams_ids))
