...
class Ui_Dialog(object):
    ...
    def update_labels(self):
        ...
        if self.steering_angle:
            self.FR_steering_label.setText(str(self.steering_angle.data[0])+"°")
            self.FL_steering_label.setText(str(self.steering_angle.data[1])+"°")
            self.BR_steering_label.setText(str(self.steering_angle.data[2])+"°")
            self.BL_steering_label.setText(str(self.steering_angle.data[3])+"°")
